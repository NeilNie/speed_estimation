...
if __name__ == '__main__':
    ...
    i3d_model = i3d(input_shape=(configs.LENGTH, configs.IMG_HEIGHT, configs.IMG_WIDTH, configs.CHANNELS), weights_path='./i3d_speed_comma_multiflow_' + str(configs.LENGTH) + '_1.h5') # weights_path='./i3d_speed_c_64_10.h5'
    i3d_model.summary()
    ...
    i3d_model.train(type='rgb-flow', labels=labels, val_labels=val_labels,
                    epochs=3, epoch_steps=3000,
                    validation=True, val_steps=2500,
                    save_path='./i3d_speed_comma_multiflow_' + str(configs.LENGTH) + '_2.h5')
